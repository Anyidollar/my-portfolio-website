      ...
      <div className={theme.isDarkmode ? "heroContainerDark" : "heroContainer"}>
        <div className="heroWrapper">
          <div className="leftHero">
            ...
            <h2 className="name">I'm Ifeanyi Onyekwere</h2>
          ...
          <div className="rightHero">
            <img
              src="https://res.cloudinary.com/danf2pvl0/image/upload/v1709118693/WhatsApp_Image_2023-09-30_at_3.36.11_PM_qiu1ap.jpg"
